...
//Canvas n°1
canvas = document.getElementById ("phase1-canvas1");
...
//Canvas n°2
canvas = document.getElementById ("phase1-canvas2");
ctx = canvas.getContext("2d");
canvas.style.display = "inline";
ctx.textBaseline = "alphabetic";
...
//Canvas n°3
canvas = document.getElementById ("phase1-canvas3");
ctx = canvas.getContext("2d");
canvas.style.display = "inline";
ctx.textBaseline = "alphabetic";
...
//Canvas n°4
canvas = document.getElementById ("phase1-canvas4");
ctx = canvas.getContext("2d");
ctx.fillStyle = "rgba(153, 0, 153, 0.7)";
ctx.font = "18pt Arial";
ctx.fillText("Updated string with new color, \u0F03", 4, 45);
...
//Canvas n°5
canvas = document.getElementById ("phase1-canvas5");
ctx = canvas.getContext("2d");
ctx.font = "20px Georgia";
ctx.fillText("Hello World!", 10, 40);

//Canvas n°6
canvas = document.getElementById ("phase1-canvas6");
ctx = canvas.getContext("2d");
...
//Canvas n°7
canvas = document.getElementById ("phase1-canvas7");
ctx = canvas.getContext("2d");
...
//Canvas n°8
canvas = document.getElementById ("phase1-canvas8");
ctx = canvas.getContext("2d");
canvas.style.display = "inline";
ctx.textBaseline = "alphabetic";
...
//Canvas n°9
canvas = document.getElementById ("phase1-canvas9");
ctx = canvas.getContext("2d");
ctx.fillStyle = "#f60";
ctx.fillRect(125, 10, 183, 40);

//Canvas n°10
canvas = document.getElementById ("phase1-canvas10");
ctx = canvas.getContext("2d");
ctx.shadowColor = '#0a0';
ctx.shadowOffsetX = 0;
ctx.shadowOffsetY = 0;
...
//Canvas n°11
canvas = document.getElementById ("phase1-canvas11");
ctx = canvas.getContext("2d");
ctx.fillStyle = "red";
ctx.beginPath();
ctx.moveTo(30, 30);
...
//Canvas n°12
canvas = document.getElementById ("phase1-canvas12");
ctx = canvas.getContext("2d");
ctx.translate(45, 45);
ctx.save();
drawPap(ctx, "red");
...
//Canvas n°13
canvas = document.getElementById ("phase1-canvas13");
ctx = canvas.getContext("2d");
var canvasWidth = 200;
...
//Canvas n°14
canvas = document.getElementById ("phase1-canvas14");
ctx = canvas.getContext("2d");
...
//Canvas n°15
canvas = document.getElementById ("phase1-canvas15");
ctx = canvas.getContext("2d");
ctx.lineWidth = 3;
